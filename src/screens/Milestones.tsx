...
const AGE_GROUPS = [
  { id: '1m', label: '1 MES', icon: Smile, emoji: '👶', months: 1 },
  { id: '3m', label: '3 MESES', icon: Bell, emoji: '🍼', months: 3 },
  { id: '6m', label: '6 MESES', icon: Accessibility, emoji: '🧸', months: 6 },
  { id: '1y', label: '1 AÑO', icon: Footprints, emoji: '🎂', months: 12 },
  { id: '1.5y', label: '1 AÑO Y 6 MESES', icon: Component, emoji: '👟', months: 18 },
  { id: '2y', label: '2 AÑOS', icon: Layers, emoji: '🎨', months: 24 },
  { id: '3y', label: '3 AÑOS', icon: Palette, emoji: '🧩', months: 36 },
  { id: '4y', label: '4 AÑOS', icon: Hash, emoji: '🚲', months: 48 },
  { id: '5y', label: '5 AÑOS', icon: BookOpen, emoji: '🏫', months: 60 },
  { id: '6y', label: '6 AÑOS', icon: Users, emoji: '🎒', months: 72 },
  { id: '7y', label: '7 AÑOS', icon: Trophy, emoji: '⚽', months: 84 },
  { id: '8y', label: '8 AÑOS', icon: Edit3, emoji: '🏆', months: 96 },
];

const CATEGORIES = [
  { 
    id: 'motor', 
    label: 'El Sendero del Movimiento', 
  ...
  { 
    id: 'language', 
    label: 'La Ruta de la Comunicación', 
    color: 'bg-pink-500', 
    text: 'text-pink-500', 
...
const MILESTONES = [
  { id: '1m-motor', ageGroup: '1m', category: 'motor', title: 'Gira la cabeza', icon: Eye, emoji: '👀', question: '¿Puede voltear su cabeza para los lados cuando está boca abajo?' },
  { id: '1m-language', ageGroup: '1m', category: 'language', title: 'Llora/Hace ruido', icon: MessageCircle, emoji: '🗣️', question: '¿Llora o hace ruido al estar incómodo(a) o querer comer?' },
  { id: '1m-social', ageGroup: '1m', category: 'social', title: 'Se tranquiliza', icon: Heart, emoji: '💖', question: '¿Se tranquiliza al hablarle o levantarlo(a)?' },

  { id: '3m-motor', ageGroup: '3m', category: 'motor', title: 'Sostiene cabeza', icon: Activity, emoji: '💪', question: '¿Logra sostener su cabeza?' },
  { id: '3m-language', ageGroup: '3m', category: 'language', title: 'Sonríe/Balbucea', icon: Smile, emoji: '😊', question: '¿Hace sonidos con la boca o sonrie?' },
  { id: '3m-social', ageGroup: '3m', category: 'social', title: 'Responde al juego', icon: Users, emoji: '🧸', question: '¿Responde cuando juegan juntos?' },

  { id: '6m-motor', ageGroup: '6m', category: 'motor', title: 'Se sienta', icon: Hand, emoji: '🧘', question: '¿Se mantiene sentado(a) aunque sea apoyándose con sus manos?' },
  { id: '6m-language', ageGroup: '6m', category: 'language', title: 'Imita sonidos', icon: Ear, emoji: '🦜', question: '¿Imita sonidos como: le, be, ps, gu?' },
  { id: '6m-social', ageGroup: '6m', category: 'social', title: 'Juega a taparse', icon: Eye, emoji: '🙈', question: '¿Se ríe cuando juegas a taparse y destaparse la cara?' },

  { id: '1y-motor', ageGroup: '1y', category: 'motor', title: 'Camina apoyado', icon: Footprints, emoji: '👣', question: '¿Puede caminar agarrado(a) de muebles?' },
  { id: '1y-language', ageGroup: '1y', category: 'language', title: 'Reacciona al NO', icon: AlertTriangle, emoji: '🛑', question: '¿Cuando está entretenido(a) y se le dice NO reacciona?' },
  { id: '1y-social', ageGroup: '1y', category: 'social', title: 'Come solo', icon: Hand, emoji: '🥣', question: '¿Empieza a comer por sí solo(a)?' },

  { id: '1.5y-motor', ageGroup: '1.5y', category: 'motor', title: 'Camina solo', icon: Footprints, emoji: '🚶', question: '¿Camina solo(a)?' },
  { id: '1.5y-language', ageGroup: '1.5y', category: 'language', title: 'Dice 4 palabras', icon: MessageCircle, emoji: '📚', question: '¿Dice cuatro palabras, además de mamá y papá?' },
  { id: '1.5y-social', ageGroup: '1.5y', category: 'social', title: 'Imita tareas', icon: Users, emoji: '🧹', question: '¿Imita tareas sencillas de casa, como: barrer o limpiar?' },

  { id: '2y-motor', ageGroup: '2y', category: 'motor', title: 'Sube muebles', icon: Activity, emoji: '🧗', question: '¿Puede subirse solo (a) a las sillas, sillones y camas?' },
  { id: '2y-language', ageGroup: '2y', category: 'language', title: 'Obedece órdenes', icon: Ear, emoji: '🫡', question: '¿Obedece órdenes sencillas, como “¡dame la pelota!"?' },
  { id: '2y-social', ageGroup: '2y', category: 'social', title: 'Intenta ser indep.', icon: Hand, emoji: '🧼', question: '¿Hace intentos por ser independiente? (Lavarse las manos o vestirse)' },

  { id: '3y-motor', ageGroup: '3y', category: 'motor', title: 'Dibuja círculo', icon: Hand, emoji: '✏️', question: '¿Puede dibujar un círculo o una cruz?' },
  { id: '3y-language', ageGroup: '3y', category: 'language', title: 'Pregunta "por qué"', icon: MessageCircle, emoji: '❓', question: '¿Frecuentemente pregunta " por qué”?' },
  { id: '3y-social', ageGroup: '3y', category: 'social', title: 'Juega con otros', icon: Users, emoji: '🧑‍🤝‍🧑', question: '¿Juega con otros niños y niñas?' },
  { id: '3y-knowledge', ageGroup: '3y', category: 'knowledge', title: 'Conoce 4 colores', icon: Brain, emoji: '🌈', question: '¿Conoce los nombres de al menos cuatro colores?' },

  { id: '4y-motor', ageGroup: '4y', category: 'motor', title: 'Dibuja persona', icon: Hand, emoji: '🧍', question: '¿Puede dibujar una persona con una o más partes de su cuerpo?' },
  { id: '4y-language', ageGroup: '4y', category: 'language', title: 'Pide "más"', icon: MessageCircle, emoji: '🍫', question: '¿Pide “más” cuando algo le gusta mucho?' },
  { id: '4y-social', ageGroup: '4y', category: 'social', title: 'Va solo al baño', icon: Activity, emoji: '🚽', question: '¿Puede ir solo al baño?' },
  { id: '4y-knowledge', ageGroup: '4y', category: 'knowledge', title: 'Cuenta hasta 10', icon: Brain, emoji: '🔟', question: '¿Puede contar hasta el número 10?' },

  { id: '5y-motor', ageGroup: '5y', category: 'motor', title: 'Brinca hacia atrás', icon: Footprints, emoji: '🐸', question: '¿Puede brincar hacia atrás con los pies juntos?' },
  { id: '5y-language', ageGroup: '5y', category: 'language', title: 'Comunica emociones', icon: Heart, emoji: '🎭', question: '¿Comunica sus emociones cuando esta: “feliz, triste o enojado”?' },
  { id: '5y-social', ageGroup: '5y', category: 'social', title: 'Le gusta la escuela', icon: Users, emoji: '🏫', question: '¿Le gusta ir a la escuela?' },
  { id: '5y-knowledge', ageGroup: '5y', category: 'knowledge', title: 'Escribe números/letras', icon: BookOpen, emoji: '✍️', question: '¿Puede escribir dos números o letras?' },

  { id: '6y-social', ageGroup: '6y', category: 'social', title: 'Sigue reglas', icon: Users, emoji: '🎲', question: '¿Puede seguir las reglas de juegos sencillos?' },
  { id: '6y-knowledge', ageGroup: '6y', category: 'knowledge', title: 'Lee 10 palabras', icon: BookOpen, emoji: '📖', question: '¿Lee por lo menos 10 palabras en voz alta?' },

  { id: '7y-social', ageGroup: '7y', category: 'social', title: 'Mantiene puntaje', icon: Activity, emoji: '⚽', question: '¿Se integra en juegos que requieren mantener puntaje?' },
  { id: '7y-knowledge', ageGroup: '7y', category: 'knowledge', title: 'Orden alfabético', icon: BookOpen, emoji: '🔤', question: '¿Enlista palabras en orden alfabético?' },

  { id: '8y-social', ageGroup: '8y', category: 'social', title: 'Se disculpa', icon: Heart, emoji: '🤝', question: '¿Se disculpa después de lastimar los sentimientos de otras personas?' },
  { id: '8y-knowledge', ageGroup: '8y', category: 'knowledge', title: 'Escribe oraciones', icon: BookOpen, emoji: '🎴', question: '¿Escribe oraciones sencillas de 3 o 4 palabras?' },
];
      ...
      <div className="sticky top-0 z-40 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm pt-4 pb-4 px-4 space-y-6 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="flex space-x-2 bg-gray-200/50 dark:bg-gray-800 p-1.5 rounded-2xl">
          <button
            ...
            className={cn("flex-1 py-2.5 text-sm font-bold rounded-xl transition-all", activeTab === 'path' ? "bg-theme-base text-theme-text shadow-md" : "text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700")}
          >
            Ruta de Desarrollo
          </button>
          <button
            onClick={() => setActiveTab('trophies')}
            className={cn("flex-1 py-2.5 text-sm font-bold rounded-xl transition-all", activeTab === 'trophies' ? "bg-theme-base text-theme-text shadow-md" : "text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700")}
          >
            Salón de la Fama
          </button>
        </div>
            ...
            return (
              ...
              >
                <div className="relative flex items-center justify-center w-20 h-20 shrink-0">
                  ...
                  <span className={cn(
                    "text-3xl z-10 select-none transition-all duration-300",
                    isLocked ? "opacity-30 grayscale" : "filter drop-shadow-sm"
                  )}>
                    {ageGroup.emoji || '🏅'}
                  </span>
                  {isLocked && (
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 animate-in fade-in">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 w-full max-w-sm shadow-2xl animate-in zoom-in-95 max-h-[90vh] flex flex-col">
            <div className="flex justify-between items-start mb-4 shrink-0">
              {(() => {
                const cat = CATEGORIES.find(c => c.id === selectedMilestone?.category);
                const isCompleted = !!completedMilestones[selectedMilestone.id];
                return (
                  <div className="flex items-center space-x-3">
                    <div className={cn(
                      "w-12 h-12 rounded-full flex items-center justify-center text-3xl shadow-md border-2 border-white dark:border-gray-700 relative overflow-hidden shrink-0",
                      isCompleted 
                        ? cat?.badgeTheme?.gradient || "from-emerald-400 via-green-500 to-emerald-600" 
                        : "bg-gray-100 dark:bg-gray-700 text-gray-400"
                    )}>
                      <span className={cn(isCompleted ? "filter drop-shadow-sm" : "opacity-45 grayscale")}>
                        {selectedMilestone.emoji}
                      </span>
                      {isCompleted && (
                        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-white/25 animate-pulse" />
                      )}
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">{AGE_GROUPS.find(a => a.id === selectedMilestone.ageGroup)?.label} • {cat?.label}</p>
                    </div>
                  </div>
                );
              })()}
              <button onClick={() => setSelectedMilestone(null)} className="p-2 bg-gray-100 dark:bg-gray-700 rounded-full text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-600 shrink-0">
                <X className="w-5 h-5" />
              </button>
            </div>
